...
<div class="row justify-content-around">
    <div class="col-md-3 py-3 text-md-right m-3 statistic-cadre cadre-one">
        <div class="row m-auto">
            ...
            <div class="w-100 title">مجموع المؤسسات</div>
            <div class="w-100 value">12</div>
            </div>
        </div>
    </div>
    <div class="col-md-3 py-3 text-md-right m-3 statistic-cadre cadre-two">
        <div class="row w-100">
            ...
            <div class="col-md-8 text-sm-center text-md-right">
            <div class="w-100 title">مجموع الأساتذة</div>
            <div class="w-100 value">10</div>
            </div>
        </div>
    </div>
    <div class="col-md-3 py-3 text-md-right m-3 statistic-cadre cadre-three">
        <div class="row w-100">
            ...
            <div class="col-md-8 text-sm-center text-md-right">
            <div class="w-100 title">عدد الزيارات</div>
            <div class="w-100 value">1</div>
            </div>
        </div>
    </div>
</div>
